      ...
      <div className="relative z-10"> <br/> <br/>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-16 mt-24">
          ...
          >
            ...
            <div className="flex mt-6 items-center gap-2 overflow-x-auto w-full px-2 py-2 scroll-smooth no-scrollbar">
              <button
              ...
              {videoIds.map((id) => (
                <div key={id} className="flex-shrink-0 w-[110px]">
                  <img
                    ...
                    className={`w-full h-[70px] object-cover rounded-md cursor-pointer border-2 transition-transform duration-300 ${
                      currentVideo === id
